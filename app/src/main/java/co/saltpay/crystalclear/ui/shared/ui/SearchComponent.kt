...
@Composable
fun SearchComponent(state: MutableState<TextFieldValue>, albumnsViewModel: AlbumnsViewModel?) {
    TextField(
        value = state.value,
        onValueChange = { value ->
            state.value = value
            albumnsViewModel?.let {
                it.applySearchWords(value.text)
            }
        },
        modifier = Modifier
            .fillMaxWidth(),
...
fun SearchViewPreview() {
    ...
    SearchComponent(textState, null)
}
